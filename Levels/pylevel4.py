...
def level4():
    ...
    pygame.display.set_caption("Impossible Game: Level 4")
    ...
    level4.crash = False
    level4.end_game = False
    stop_move = False
    level4.retry = False
    while not level4.crash:
        wind_size = pygame.Surface.get_size(gameDisplay)
        ...
        if check_ob1_col or check_ob2_col or check_ob3_col or check_ob4_col or check_ob5_col:
            x_user = 20
